...
const FILTER_ALPHA = 0.12;        // ค่าความสมูทในการกรอง (ยิ่งน้อยยิ่งนิ่ง แนะนำ 0.05 - 0.15)
...
window.addEventListener("deviceorientation", (event) => {
    ...
    // ตรวจสอบ Threshold เพื่อล็อคตัวเลขให้นิ่งสนิทเมื่อไม่เคลื่อนไหว
